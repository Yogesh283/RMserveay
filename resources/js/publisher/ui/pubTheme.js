...
export const pub = {
    ...
    card:
        'rounded-2xl border border-[#2A3550] bg-[#111827] shadow-[0_8px_32px_rgba(0,0,0,0.35)] backdrop-blur-sm transition-all duration-200',
    cardHover: 'hover:border-[#7C5CFF]/30 hover:shadow-[0_0_28px_rgba(124,92,255,0.12)]',
    innerCard: 'rounded-xl border border-[#2A3550] bg-[#1A2235]',
    input:
        'w-full rounded-xl border border-[#2A3550] bg-[#1A2235] px-4 py-2.5 text-sm text-white placeholder:text-[#9CA3AF]/55 outline-none transition duration-200 focus:border-[#7C5CFF] focus:ring-2 focus:ring-[#7C5CFF]/25',
    select: 'appearance-none rounded-xl border border-[#2A3550] bg-[#1A2235] px-4 py-2.5 text-sm text-white outline-none transition duration-200 focus:border-[#7C5CFF] focus:ring-2 focus:ring-[#7C5CFF]/25',
    ...
    tableWrap: 'overflow-hidden rounded-2xl border border-[#2A3550] bg-[#111827] shadow-[0_8px_32px_rgba(0,0,0,0.25)]',
